...
})({"guTOK":[function(require,module,exports) {
...
(0, _jqueryDefault.default)(window).on("load", function() {
    ...
    function updateChoiceIcon(choose) {
        if (choose === "rock") return "fa-hand-back-fist";
        else if (choose === "paper") return "fa-hand";
        else if (choose === "scissors") return "fa-hand-scissors";
    ...
    function generateChoice() {
        condition[1] = choice[Math.floor(Math.random() * 3 + 0)];
    }
    function checkWinner() {
        for (const winningConditionItem of winningCondition){
            if (condition[0] === condition[1]) break;
            if (winningConditionItem[0] === condition[0] && winningConditionItem[1] === condition[1]) {
                score[0]++;
                break;
            }
            if (winningConditionItem[0] === condition[1] && winningConditionItem[1] === condition[0]) {
                score[1]++;
                break;
            }
        }
        if (score[0] === 3) {
            (0, _jqueryDefault.default)(".popup").show();
            (0, _jqueryDefault.default)(".popup-text").text("User won!");
        } else if (score[1] === 3) {
            (0, _jqueryDefault.default)(".popup").show();
            (0, _jqueryDefault.default)(".popup-text").text("Computer won!");
        }
    }
    function updateScore() {
        (0, _jqueryDefault.default)(".user-choice").html(`<i class="fa-solid ${updateChoiceIcon(condition[0])}"></i>`);
        (0, _jqueryDefault.default)(".computer-choice").html(`<i class="fa-solid ${updateChoiceIcon(condition[1])}"></i>`);
        (0, _jqueryDefault.default)(".score").text(`${score[0]} - ${score[1]}`);
    }
    (0, _jqueryDefault.default)('[data-rock="rock"]').on("click", function() {
        condition[0] = this.dataset.rock;
        updateData();
    });
    (0, _jqueryDefault.default)('[data-paper="paper"]').on("click", function() {
        condition[0] = this.dataset.paper;
        updateData();
    });
    (0, _jqueryDefault.default)('[data-scissors="scissors"]').on("click", function() {
        condition[0] = this.dataset.scissors;
        updateData();
    });
    (0, _jqueryDefault.default)(".restart-btn").on("click", function() {
        score = [
            0,
            0
        ];
        ...
        (0, _jqueryDefault.default)(".user-choice").html(``);
        (0, _jqueryDefault.default)(".computer-choice").html(``);
        (0, _jqueryDefault.default)(".score").text(`${score[0]} - ${score[1]}`);
        (0, _jqueryDefault.default)(".popup").hide();
    });
});
...
},{}]},["guTOK","amwXi"], "amwXi", "parcelRequire2062")
