...
var T="3.7.1",w=/HTML$/i,C=function(e,t){// The jQuery object is actually just the init constructor 'enhanced'
...
jquery:T,constructor:C,// The default length of a jQuery object is 0
...
C.each("Boolean Number String Function Array Date RegExp Object Error Symbol".split(" "),function(e,t){l["[object "+t+"]"]=t.toLowerCase()});var S=r.pop,j=r.sort,A=r.splice,D="[\\x20\\t\\r\\n\\f]",N=RegExp("^"+D+"+|((?:^|[^\\\\])(?:\\\\.)*)"+D+"+$","g");// Note: an element does not contain itself
...
"\x00"===e?"�":e.slice(0,-1)+"\\"+e.charCodeAt(e.length-1).toString(16)+" ":"\\"+e}C.escapeSelector=function(e){return(e+"").replace(q,L)},function(){var t,n,i,a,l,c,p,d,g,v,m=s,x=C.expando,b=0,T=0,w=ee(),k=ee(),q=ee(),L=ee(),H=function(e,t){return e===t&&(l=!0),0},O="checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped",// https://www.w3.org/TR/css-syntax-3/#ident-token-diagram
P="(?:\\\\[\\da-fA-F]{1,6}"+D+"?|\\\\[^\\r\\n\\f]|[\\w-]|[^\x00-\\x7f])+",R="\\["+D+"*("+P+")(?:"+D+// Operator (capture 2)
"*([*^$|!~]?=)"+D+// "Attribute values must be CSS identifiers [capture 5] or strings [capture 3 or capture 4]"
"*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|("+P+"))|)"+D+"*\\]",M=":("+P+")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|"+R+")*)|.*)\\)|)",I=RegExp(D+"+","g"),W=RegExp("^"+D+"*,"+D+"*"),F=RegExp("^"+D+"*([>+~]|"+D+")"+D+"*"),$=RegExp(D+"|>"),B=new RegExp(M),_=RegExp("^"+P+"$"),z={ID:RegExp("^#("+P+")"),CLASS:RegExp("^\\.("+P+")"),TAG:RegExp("^("+P+"|[*])"),ATTR:RegExp("^"+R),PSEUDO:RegExp("^"+M),CHILD:RegExp("^:(only|first|last|nth|nth-last)-(child|of-type)(?:\\("+D+"*(even|odd|(([+-]|)(\\d*)n|)"+D+"*(?:([+-]|)"+D+"*(\\d+)|))"+D+"*\\)|)","i"),bool:RegExp("^(?:"+O+")$","i"),// For use in libraries implementing .is()
...
header:function(e){return X.test(e.nodeName)},input:function(e){return U.test(e.nodeName)},button:function(e){return E(e,"input")&&"button"===e.type||E(e,"button")},text:function(e){var t;return E(e,"input")&&"text"===e.type&&// Support: IE <10 only
...
t?s.length:s?Z.error(e):k(e,u).slice(0))}function el(e){for(var t=0,n=e.length,r="";t<n;t++)r+=e[t].value;return r}function ec(e,t,n){var r=t.dir,i=t.next,o=i||r,a=n&&"parentNode"===o,s=T++;return t.first?function(t,n,i){for(;t=t[r];)if(1===t.nodeType||a)return e(t,n,i);return!1}:function(t,n,u){var l,c,f=[b,s];// We can't set arbitrary data on XML nodes, so they don't benefit from combinator caching
...
(p=q(e,(r=l.length>0,o=f.length>0,a=function(e,t,a,s,u){var p,h,g,v=0,y="0",x=e&&[],T=[],w=i,k=e||o&&n.find.TAG("*",u),E=b+=null==w?1:Math.random()||.1,j=k.length;// Add elements passing elementMatchers directly to results
...
// two documents; shallow comparisons work.
// eslint-disable-next-line eqeqeq
(i=t==c||t||u);y!==j&&null!=(p=k[y]);y++){if(o&&p){for(h=0,t||p.ownerDocument==c||(ea(p),a=!d);g=f[h++];)if(g(p,t||c,a)){m.call(s,p);break}u&&(b=E)}r&&((p=!g&&p)&&v--,e&&x.push(p))}// Apply set filters to unmatched elements
...
v+=y,r&&y!==v){for(h=0;g=l[h++];)g(x,T,t,a);if(e){// Reintegrate element matches to eliminate the need for sorting
if(v>0)for(;y--;)x[y]||T[y]||(T[y]=S.call(s));// Discard index placeholder values to get only actual matches
T=ep(T)}// Add matches to results
m.apply(s,T),u&&!e&&T.length>0&&v+l.length>1&&C.uniqueSort(s)}return u&&(b=E,i=w),x},r?et(a):a))).selector=e}return p}/**
...
C.merge(this,C.parseHTML(r[1],t&&t.nodeType?t.ownerDocument||t:y,!0)),R.test(r[1])&&C.isPlainObject(t))for(r in t)g(this[r])?this[r](t[r]):this.attr(r,t[r]);return this}return!t||t.jquery?(t||n).find(e):this.constructor(t).find(e);// HANDLE: $(DOMElement)
...
(e4=y.createElement("input")).setAttribute("type","radio"),e4.setAttribute("checked","checked"),e4.setAttribute("name","t"),e5.appendChild(e4),// Support: Android <=4.1 only
...
function eC(e,t){for(var n=0,r=e.length;n<r;n++)er.set(e[n],"globalEval",!t||er.get(t[n],"globalEval"))}eT.tbody=eT.tfoot=eT.colgroup=eT.caption=eT.thead,eT.th=eT.td,h.option||(eT.optgroup=eT.option=[1,"<select multiple='multiple'>","</select>"]);var ek=/<|&#?\w+;/;function eE(e,t,n,r,i){for(var o,a,s,u,l,c=t.createDocumentFragment(),f=[],p=0,d=e.length;p<d;p++)if((o=e[p])||0===o){// Add nodes directly
if("object"===b(o))// push.apply(_, arraylike) throws on ancient WebKit
C.merge(f,o.nodeType?[o]:o);else if(ek.test(o)){for(a=a||c.appendChild(t.createElement("div")),s=eT[(ex.exec(o)||["",""])[1].toLowerCase()]||eT._default,a.innerHTML=s[1]+C.htmlPrefilter(o)+s[2],// Descend through wrappers to the right content
...
a=ew(c.appendChild(o),"script"),u&&eC(a),n)for(l=0;o=a[l++];)eb.test(o.type||"")&&n.push(o)}return c}var eS=/^([^.]*)(?:\.(.+)|)/;function ej(){return!0}function eA(){return!1}function eD(e,t,n,r,i,o){var a,s;// Types can be a map of types/handlers
...
(t=(t||"").match(_)||[""]).length;l--;)d=g=(s=eS.exec(t[l])||[])[1],h=(s[2]||"").split(".").sort(),d&&(// If event changes its type, use the special event handlers for the changed type
...
_default:function(e){var t=e.target;return em.test(t.type)&&t.click&&E(t,"input")&&er.get(t,"click")||E(t,"a")}},beforeunload:{postDispatch:function(e){void 0!==e.result&&e.originalEvent&&(e.originalEvent.returnValue=e.result)}}}},C.removeEvent=function(e,t,n){e.removeEventListener&&e.removeEventListener(t,n)},C.Event=function(e,t){// Allow instantiation without the 'new' keyword
...
function eP(e){return e.type=(null!==e.getAttribute("type"))+"/"+e.type,e}function eR(e){return"true/"===(e.type||"").slice(0,5)?e.type=e.type.slice(5):e.removeAttribute("type"),e}function eM(e,t){var n,r,i,o,a,s;if(1===t.nodeType){// 1. Copy private data: events, handlers, etc.
...
for(u=(s=C.map(ew(i,"script"),eP)).length;f<p;f++)l=i,f!==d&&(l=C.clone(l,!0,!0),u&&// push.apply(_, arraylike) throws on ancient WebKit
C.merge(s,ew(l,"script"))),n.call(e[f],l,f);if(u)// Evaluate executable scripts on first document insertion
for(c=s[s.length-1].ownerDocument,// Re-enable scripts
C.map(s,eR),f=0;f<u;f++)l=s[f],eb.test(l.type||"")&&!er.access(l,"globalEval")&&C.contains(c,l)&&(l.src&&"module"!==(l.type||"").toLowerCase()?C._evalUrl&&!l.noModule&&C._evalUrl(l.src,{nonce:l.nonce||l.getAttribute("nonce")},c):// needed as in XML documents they're already not visible when
...
a=ew(s),i=(o=ew(e)).length;r<i;r++)!// Fix IE bugs, see support tests
...
if(t){if(n)for(r=0,o=o||ew(e),a=a||ew(s),i=o.length;r<i;r++)eM(o[r],a[r]);else eM(e,s)}// Return the cloned set
return(// Preserve script evaluation history
(a=ew(s,"script")).length>0&&eC(a,!u&&ew(e,"script")),s)},cleanData:function(e){for(var t,n,r,i=C.event.special,o=0;void 0!==(n=e[o]);o++)if(et(n)){if(t=n[er.expando]){if(t.events)for(r in t.events)i[r]?C.event.remove(n,r):C.removeEvent(n,r,t.handle);// Support: Chrome <=35 - 45+
...
C.cleanData(ew(e,!1)),// Remove any remaining nodes
...
if("string"==typeof e&&!eq.test(e)&&!eT[(ex.exec(e)||["",""])[1].toLowerCase()]){e=C.htmlPrefilter(e);try{for(;n<r;n++)t=this[n]||{},1===t.nodeType&&(C.cleanData(ew(t,!1)),t.innerHTML=e);t=0;// If using innerHTML throws an exception, use the fallback method
...
return eI(this,arguments,function(t){var n=this.parentNode;0>C.inArray(this,e)&&(C.cleanData(ew(this)),n&&n.replaceChild(t,this));// Force callback invocation
...
for(i in r=n.call(e),t)e.style[i]=o[i];return r},ez=RegExp(ec.join("|"),"i");function eU(e,t,n){var r,i,o,a,s=e$.test(t),// Retrieving style before computed somehow
...
C.fx.step={};var e5,e4,e6,e9,e8=/^(?:toggle|show|hide)$/,e7=/queueHooks$/;// Animations created synchronously will run synchronously
...
return this.name&&!C(this).is(":disabled")&&tw.test(this.nodeName)&&!tT.test(e)&&(this.checked||!em.test(e))}).map(function(e,t){var n=C(this).val();return null==n?null:Array.isArray(n)?C.map(n,function(e){return{name:t.name,value:e.replace(tb,"\r\n")}}):{name:t.name,value:n.replace(tb,"\r\n")}}).get()}});var tC=/%20/g,tk=/#.*$/,tE=/([?&])_=[^&]*/,tS=/^(.*?):[ \t]*([^\r\n]*)$/mg,tj=/^(?:GET|HEAD)$/,tA=/^\/\//,/* Prefilters
...
n=n||{};var r,i,o,a,s,u,l,c,f,p,d=C.ajaxSetup({},n),h=d.context||d,g=d.context&&(h.nodeType||h.jquery)?C(h):C.event,v=C.Deferred(),m=C.Callbacks("once memory"),x=d.statusCode||{},b={},T={},w="canceled",k={readyState:0,// Builds headers hashtable if needed
...
setRequestHeader:function(e,t){return null==l&&(b[e=T[e.toLowerCase()]=T[e.toLowerCase()]||e]=t),this},// Overrides response content-type header
...
abort:function(e){var t=e||w;return r&&r.abort(t),E(0,t),this}};// A cross-domain request is in order when the origin doesn't match the current origin.
if(// Attach deferreds
...
function E(t,n,a,u){var f,p,y,b,T,w=n;l||(l=!0,s&&e.clearTimeout(s),// Dereference transport for early garbage collection
...
if(a&&e.throws)t=a(t);else try{t=a(t)}catch(e){return{state:"parsererror",error:a?e:"No conversion from "+u+" to "+o}}}}}return{state:"success",data:t}}(d,b,k,f),f?(d.ifModified&&((T=k.getResponseHeader("Last-Modified"))&&(C.lastModified[i]=T),(T=k.getResponseHeader("etag"))&&(C.etag[i]=T)),204===t||"HEAD"===d.type?w="nocontent":304===t?w="notmodified":(w=b.state,p=b.data,f=!(y=b.error))):(// Extract error from statusText and normalize for non-aborts
y=w,(t||!w)&&(w="error",t<0&&(t=0))),// Set data for the fake xhr object
k.status=t,k.statusText=(n||w)+"",f?v.resolveWith(h,[p,w,k]):v.rejectWith(h,[k,w,y]),// Status-dependent callbacks
k.statusCode(x),x=void 0,c&&g.trigger(f?"ajaxSuccess":"ajaxError",[k,d,f?p:y]),// Complete
m.fireWith(h,[k,w]),!c||(g.trigger("ajaxComplete",[k,d]),--C.active||C.event.trigger("ajaxStop")))}return k},getJSON:function(e,t,n){return C.get(e,t,n,"json")},getScript:function(e,t){return C.get(e,void 0,t,"script")}}),C.each(["get","post"],function(e,t){C[t]=function(e,n,r,i){// The url can be an options object (which then must have .url)
...
t=C(e,this[0].ownerDocument).eq(0).clone(!0),this[0].parentNode&&t.insertBefore(this[0]),t.map(function(){for(var e=this;e.firstElementChild;)e=e.firstElementChild;return e}).append(this)),this},wrapInner:function(e){return g(e)?this.each(function(t){C(this).wrapInner(e.call(this,t))}):this.each(function(){var t=C(this),n=t.contents();n.length?n.wrapAll(e):t.append(e)})},wrap:function(e){var t=g(e);return this.each(function(n){C(this).wrapAll(t?e.call(this,n):e)})},unwrap:function(e){return this.parent(e).not("body").each(function(){C(this).replaceWith(this.childNodes)}),this}}),C.expr.pseudos.hidden=function(e){return!C.expr.pseudos.visible(e)},C.expr.pseudos.visible=function(e){return!!(e.offsetWidth||e.offsetHeight||e.getClientRects().length)},C.ajaxSettings.xhr=function(){try{return new e.XMLHttpRequest}catch(e){}};var tR={// File protocol always yields status code 0, assume 200
...
(r=(t=y.implementation.createHTMLDocument("")).createElement("base")).href=y.location.href,t.head.appendChild(r)):t=y),i=R.exec(e),o=!n&&[],i)?[t.createElement(i[1])]:(i=eE([e],t,o),o&&o.length&&C(o).remove(),C.merge([],i.childNodes))},/**
...
return n=eU(e,t),eF.test(n)?C(e).position()[t]+"px":n})}),// Create innerHeight, innerWidth, height, width, outerHeight and outerWidth methods
...
!isNaN(e-parseFloat(e))},C.trim=function(e){return null==e?"":(e+"").replace(tF,"$1")},"function"==typeof define&&define.amd&&define("jquery",[],function(){return C});var t$=e.jQuery,tB=e.$;return C.noConflict=function(t){return e.$===C&&(e.$=tB),t&&e.jQuery===C&&(e.jQuery=t$),C},void 0===t&&(e.jQuery=e.$=C),C},"object"==typeof r?// is present, execute the factory and get jQuery.
// For environments that do not have a `window` with a `document`
// (such as Node.js), expose a factory as module.exports.
// This accentuates the need for the creation of a real `window`.
// e.g. var jQuery = require("jquery")(window);
// See ticket trac-14549 for more info.
r=t.document?n(t,!0):function(e){if(!e.document)throw Error("jQuery requires a window with a document");return n(e)}:n(t),/*@__PURE__*/e(r)(window).on("load",function(){let t="#6c757d";function n(t){let n=URL.createObjectURL(t);/*@__PURE__*/e(r)(".input-container").css("background",`url(${n})`),/*@__PURE__*/e(r)(".input-container").css("background-position","center"),/*@__PURE__*/e(r)(".input-container").css("background-size","100%"),/*@__PURE__*/e(r)(".input-container").css("background-repeat","no-repeat"),/*@__PURE__*/e(r)(".input-file").css("z-index","-1")}/*@__PURE__*/e(r)(".input-container").on("drop",function(i){return i.preventDefault(),i.stopPropagation(),/*@__PURE__*/e(r)(".input-container").css("border",`5px dashed ${t}`),i.originalEvent.dataTransfer&&i.originalEvent.dataTransfer.files.length&&n(i.originalEvent.dataTransfer.files[0]),!1}),/*@__PURE__*/e(r)(".input-container").on("dragover",function(t){t.preventDefault(),/*@__PURE__*/e(r)(".input-container").css("border","5px dashed #fff")}),/*@__PURE__*/e(r)(".input-container").on("dragleave",function(n){n.preventDefault(),/*@__PURE__*/e(r)(".input-container").css("border",`5px dashed ${t}`)}),/*@__PURE__*/e(r)(".input-file").on("change",function(e){n(e.target.files[0])})});//# sourceMappingURL=index.86ce0993.js.map

//# sourceMappingURL=index.86ce0993.js.map
