...
(0, _jqueryDefault.default)(window).on("load", function() {
    ...
    function previewImage(image) {
        ...
        (0, _jqueryDefault.default)(".input-container").css("background", `url(${imageSrc})`);
        (0, _jqueryDefault.default)(".input-container").css("background-position", "center");
        (0, _jqueryDefault.default)(".input-container").css("background-size", "100%");
        (0, _jqueryDefault.default)(".input-container").css("background-repeat", "no-repeat");
        (0, _jqueryDefault.default)(".input-file").css("z-index", "-1");
    }
    (0, _jqueryDefault.default)(".input-container").on("drop", function(event) {
        event.preventDefault();
        event.stopPropagation();
        (0, _jqueryDefault.default)(".input-container").css("border", `5px dashed ${borderColor}`);
    ...
    (0, _jqueryDefault.default)(".input-container").on("dragover", function(event) {
        event.preventDefault();
        (0, _jqueryDefault.default)(".input-container").css("border", `5px dashed ${activeBorderColor}`);
    });
    (0, _jqueryDefault.default)(".input-container").on("dragleave", function(event) {
        event.preventDefault();
        (0, _jqueryDefault.default)(".input-container").css("border", `5px dashed ${borderColor}`);
    });
    (0, _jqueryDefault.default)(".input-file").on("change", function(event) {
...
},{}]},["guTOK","amwXi"], "amwXi", "parcelRequire98b6")
